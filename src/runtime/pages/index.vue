...
<template>
  <div
    class="ducktory:h-full ducktory:w-full ducktory:grid ducktory:place-items-center ducktory:content-center"
  >
    <div class="ducktory:max-w-6xl">
      <h1
        ...
        v-text="title"
      />
      <p class="ducktory:text-sm ducktory:text-secondary ducktory:text-center" v-text="subtitle" />

      <div
        class="ducktory:flex ducktory:flex-col ducktory:xl:flex-row-reverse ducktory:gap-4 ducktory:mt-8"
      >
        ...
        >
          <h2 class="ducktory:text-lg ducktory:text-secondary ducktory:text-center">Quick Links</h2>
        ...
        >
          ...
          <div
            class="ducktory:bg-primary ducktory:text-secondary ducktory:rounded-2xl ducktory:my-2 ducktory:p-3"
          >
            <strong>Note:</strong> The integration feature is currently still Work In Progress and
            does not work yet!
          </div>

          <ul class="ducktory:flex ducktory:flex-col ducktory:gap-2 ducktory:mt-2">
            <li v-for="integration in integrations" :key="integration.name">
